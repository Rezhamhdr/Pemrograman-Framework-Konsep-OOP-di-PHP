...
$beli->setName("CD MUSIC A7X");
$beli->setPrice("200000");
$beli->setDiscount("Diskon :</br> 1. CDMusic = 5% <br/> 2. CDRack = 0%
(Tidak ada discount)");

echo "***PRODUCT*** <br/>"; 
echo "Nama Product :".$beli->getName()."<br/>";
echo "Harga :Rp.".$beli->getPrice().",-<br/>";
echo $beli->getDiscount()."<br/><hr/><hr/>";
$beli_cdm->setArtist("A7X");
$beli_cdm->setGenre("Rock");
$beli_cdm->setDiscount("5%");
$beli_cdm->setPrice(200000);

echo "***SELAMAT DATANG DI CDMUSIC 90S*** <br/>"; 
echo "Nama Product : " . $beli->getName() . "<br/>"; 
echo "Artis : " . $beli_cdm->getArtist() . "<br/>";
echo "Genre : " . $beli_cdm->getGenre() . "<br/>";

echo  "Total  Harga  :  Rp."  .  $beli_cdm->getPrice()  .  ",-<br/>Harga  diatas  sudah termasuk PPN sebesar 10% dan Discount 5%<br/><br/><hr/><hr/>";


$beli_cdr->setCapacity("500mb");

$beli_cdr->setModel("New Album");
